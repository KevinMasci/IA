...
creo que era asi la bd
Pedia que con un menu recursivo, se haga
1- Ingresar un nombre de materia, anio, lista de dnis de alumnos, se devuelvan 2 listas una con los nombres de los aprobados para esa materia en ese anio y otra con los no aprobados.
